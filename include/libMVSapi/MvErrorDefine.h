...
#define MV_E_ABNORMAL_IMAGE                                                                                            \
  0x8000000B  ///< \~chinese 异常图像，可能是丢包导致图像不完整       \~english Abnormal image, maybe incomplete image
              ///< because of lost packet
...
#define MV_E_UPG_CONFLICT                                                                                              \
  0x80000402  ///< \~chinese 升级冲突（设备已经在升级了再次请求升级即返回此错误）   \~english Upgrading conflicted
              ///< (repeated upgrading requests during device upgrade)
